...
<svg viewBox="0 0 595.3 841.9" style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0 }}>
    ...
    <image href={frontView} x="20.8" y="604.7" width="272.2" height="218.3" preserveAspectRatio="xMidYMid meet" />
    <image href={sideView} x="302.2" y="604.7" width="272.2" height="218.3" preserveAspectRatio="xMidYMid meet" />
